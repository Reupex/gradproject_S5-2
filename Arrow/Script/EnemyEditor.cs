...
//        {
//            case ArrowGame.MonsterType.normal:
...
//        GUI.color = tempColor;
//        selected.monsterType = (ArrowGame.MonsterType)EditorGUILayout.EnumPopup("몬스터 종류", selected.monsterType);
